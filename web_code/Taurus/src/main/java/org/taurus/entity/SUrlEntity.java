...
public class SUrlEntity implements Serializable {
	...
	public String toString() {
		return "SUrlEntity{" + "urlId=" + urlId + ", urlPath=" + urlPath + ", urlType=" + urlType + ", urlPlatform="
				+ urlPlatform + ", urlRemarks=" + urlRemarks + ", urlDelFlg=" + urlDelFlg + ", urlCreateTime="
				+ urlCreateTime + ", urlCreateUser=" + urlCreateUser + ", urlModifyTime=" + urlModifyTime
