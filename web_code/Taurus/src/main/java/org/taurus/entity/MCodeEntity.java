...
public class MCodeEntity implements Serializable {
	...
	public String toString() {
		return "MCodeEntity{" + "codeId=" + codeId + ", codeGroup=" + codeGroup + ", codeName=" + codeName
				+ ", codeValue=" + codeValue + ", codeOrder=" + codeOrder + ", codeDelFlg=" + codeDelFlg
				+ ", codeCreateTime=" + codeCreateTime + ", codeCreateUser=" + codeCreateUser + ", codeModifyTime="
				+ codeModifyTime + ", codeModifyUser=" + codeModifyUser + "}";
	}
}
