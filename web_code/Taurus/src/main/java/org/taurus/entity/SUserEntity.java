...
public class SUserEntity implements Serializable {
	...
	public String toString() {
		return "SUserEntity{" + "userId=" + userId + ", userNumber=" + userNumber + ", userPwd=" + userPwd
				+ ", userName=" + userName + ", userHead=" + userHead + ", userPlatform=" + userPlatform + ", userQq="
				+ userQq + ", userEmail=" + userEmail + ", userDelFlg=" + userDelFlg + ", userCreateTime="
				+ userCreateTime + ", userCreateUser=" + userCreateUser + ", userModifyTime=" + userModifyTime
